...
router.post('/ingredients/disable', rh.voidFun); // Assigns False boolean to inStock property of Ingredient in database and shows ingredient as out-of-stock on page
router.post('/ingredients/edit', rh.voidFun); // Updates name and price for the ingredient and reflects this change on the page
