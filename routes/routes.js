...
router.get('/ingredients', rh.sayHi); // Shows list of ingredients (name & price) with Out-of-Stock, add, and edit buttons
router.post('/ingredients/add', rh.sayHi); // Adds a new ingredient to the database and displays it
